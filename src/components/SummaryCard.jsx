  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      ...
      <div className={`p-4 rounded-lg mb-6 ${
        balance >= 0 ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'
      }`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="text-center p-3 bg-blue-50 rounded-lg">
          ...
          <p className="text-lg font-semibold text-blue-600">{formatAmount(income)}</p>
        </div>
        ...
        <div className="text-center p-3 bg-red-50 rounded-lg">
          ...
          <p className="text-lg font-semibold text-red-600">-{formatAmount(totalSpent)}</p>
        </div>
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600">Total Income</p>
          <p className="text-lg font-semibold text-gray-600">{formatAmount(income + totalIncome)}</p>
        </div>
      </div>
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-3">
          <h3 className="text-lg font-medium text-gray-800">Category Budgets</h3>
          <button
      ...
      {/* 6-Month Projection */}
      <div className="mt-6">
        <h3 className="text-lg font-medium text-gray-800 mb-3">6-Month Projection</h3>
